...
'''
This script can be used to manually trigger the lambda version of this work
'''
...
# set variables
rds_cluster_name = ["custoemr-replication-db"]
account_id = ["xxxxx"] # custoemr account ID
...
def _generate_rds_snapshot(clusterIdentifier, rds_client):
    """This is ultimately for custoemr snapshot sharing"""
...
def load_and_wait_database():
    ...
    task_arns = ['arn:aws:dms:us-east-2:xxx:task:xx',
                    'arn:aws:dms:us-east-2:xxx:task:xx']
